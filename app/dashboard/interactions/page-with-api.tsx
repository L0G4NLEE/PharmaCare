...
export default function InteractionsPage() {
  ...
  const handleDeleteInteraction = (interaction: any) => {
    setSelectedInteraction(interaction)
    ...
    <>
        ...
        <div className="bg-white rounded-lg border shadow-sm mb-6">
          ...
          <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
            <Select value={medicine1} onValueChange={setMedicine1}>
              ...
              <SelectContent>
                {/* Trong thực tế, danh sách thuốc sẽ được lấy từ API */}
                <SelectItem value="Paracetamol 500mg">Paracetamol 500mg</SelectItem>
                <SelectItem value="Vitamin C 1000mg">Vitamin C 1000mg</SelectItem>
                ...
                <SelectItem value="Cetirizine 10mg">Cetirizine 10mg</SelectItem>
                <SelectItem value="Ibuprofen 400mg">Ibuprofen 400mg</SelectItem>
                <SelectItem value="Metformin 500mg">Metformin 500mg</SelectItem>
                <SelectItem value="Warfarin 5mg">Warfarin 5mg</SelectItem>
                <SelectItem value="Clopidogrel 75mg">Clopidogrel 75mg</SelectItem>
                <SelectItem value="Digoxin 0.25mg">Digoxin 0.25mg</SelectItem>
              </SelectContent>
            </Select>
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <InteractionForm onSuccess={handleAddSuccess} onCancel={() => setIsAddDialogOpen(false)} />
        </DialogContent>
      </Dialog>
